...
// node_modules/three/examples/jsm/tsl/display/StereoCompositePassNode.js
...
var StereoCompositePassNode = class extends PassNode {
  ...
  constructor(scene, camera) {
    ...
    this._mapLeft = texture2(this._renderTargetL.texture);
    this._mapRight = texture2(this._renderTargetR.texture);
    this._material = null;
  }
  /**
  ...
  updateBefore(frame) {
    ...
    const size = renderer.getSize(_size2);
    this.setSize(size.width, size.height);
...
var StereoCompositePassNode_default = StereoCompositePassNode;

// node_modules/three/examples/jsm/tsl/display/AnaglyphPassNode.js
var AnaglyphPassNode = class extends StereoCompositePassNode_default {
  static get type() {
  ...
  constructor(scene, camera) {
    ...
    this._colorMatrixLeft = uniform2(new Matrix3().fromArray([
      0.4561,
      -0.0400822,
      -0.0152161,
      0.500484,
    ...
    this._colorMatrixRight = uniform2(new Matrix3().fromArray([
      -0.0434706,
      0.378476,
      -0.0721527,
      -0.0879388,
  ...
  setup(builder) {
    ...
    const anaglyph = Fn2(() => {
      ...
      const color3 = clamp2(this._colorMatrixLeft.mul(colorL.rgb).add(this._colorMatrixRight.mul(colorR.rgb)));
      return vec42(color3.rgb, max2(colorL.a, colorR.a));
    });
...
var AnaglyphPassNode_default = AnaglyphPassNode;
var anaglyphPass = (scene, camera) => nodeObject2(new AnaglyphPassNode(scene, camera));
export {
  anaglyphPass,
  AnaglyphPassNode_default as default
};
...
three/build/three.tsl.js:
   ...
   *)
*/
//# sourceMappingURL=three_examples_jsm_tsl_display_AnaglyphPassNode__js.js.map
