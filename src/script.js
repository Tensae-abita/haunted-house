...
const floorColorTexture = textureLoader.load(
  "./floor/rocky_terrain_1k/rocky_terrain_1k/rocky_terrain_diff_1k.jpg"
);
const floorARMTexture = textureLoader.load(
  "./floor/rocky_terrain_1k/rocky_terrain_1k/rocky_terrain_rough_1k.exr"
);
const floorNormalTexture = textureLoader.load(
  "./floor/rocky_terrain_1k/rocky_terrain_1k/rocky_terrain_nor_gl_1k.jpg"
);
const floorDIspTexture = textureLoader.load(
  "./floor/rocky_terrain_1k/rocky_terrain_1k/rocky_terrain_disp_1k.png"
);
//wall
const wallColorTexture = textureLoader.load("./walls/rock_wall_13_diff_1k.jpg");
const wallARMTexture = textureLoader.load("./walls/rock_wall_13_arm_1k.jpg");

const wallNormalTexture = textureLoader.load(
  "./walls/rock_wall_13_nor_gl_1k.jpg"
);

//roof
//wall
const roofColorTexture = textureLoader.load(
  "./roof/grey_roof_tiles_02_diff_1k.jpg"
);
const roofARMTexture = textureLoader.load(
  "./roof/grey_roof_tiles_02_arm_1k.jpg"
);

const roofNormalTexture = textureLoader.load(
  "./roof/grey_roof_tiles_02_nor_gl_1k.jpg"
);
...
const tick = () => {
  ...
  ghost3.position.y =
    ...
    Math.sin(ghost3Angle * 2.23) *
    Math.sin(ghost3Angle * 3.45);
  // camera.position.x = Math.cos(ghost1Angle * 0.1) * 8;
  // camera.position.z = Math.sin(ghost1Angle * 0.1) * 8;
  // camera.position.y = Math.abs(Math.sin(ghost2Angle * 0.1) * 6) + 1;
  // Update controls
  controls.update();
